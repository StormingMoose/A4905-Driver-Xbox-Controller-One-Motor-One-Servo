...
int pos = 85; // intitial servo postion to be at 90 degrees to make it straight different from 90 for mechanical adjustment
...
const char* ssid = "your home network";
const char* password = "its password";  // change the *'s to your favourite vegetable  // I use the fing android app to find the ip address
